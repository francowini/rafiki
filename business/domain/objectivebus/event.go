...
func ActionDeletedData(o Objective) delegate.Data {
...
func (b *Business) actionLifeVisionDeleted(ctx context.Context, data delegate.Data) error {
	...
	b.log.Info(ctx, "action-lifevisiondeleted", "life_vision_id", params.LifeVisionID, "status", "objectives deleted via CASCADE")
