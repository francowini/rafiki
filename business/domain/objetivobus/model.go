...
var (
	...
	ErrMetricaNotInitialized        = errors.New("metrica values not initialized")
	ErrIncrementOrValueRequired     = errors.New("either increment or value must be provided")
	ErrFrecuenciaTipoRequired       = errors.New("frecuencia_tipo required for frecuencia tracking")
	ErrMetricaOnlyForResultado      = errors.New("metrica_objetivo only valid for resultado tracking")
	ErrFrecuenciaOnlyForFrecuencia  = errors.New("frecuencia fields only valid for frecuencia tracking")
)
